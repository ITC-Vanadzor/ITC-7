...
std::cout << "Import coordinates for 3 tops of triangle" << std::endl;
std::cout << "Import coordinates for top A " << std::endl;
int x1, y1;
std::cin >> x1;
std::cin >> y1;
std::cout << "Import coordinates for top B " << std::endl;
int x2, y2;
std::cin >> x2;
std::cin >> y2;
std::cout << "Import coordinates for top C " << std::endl;
int x3, y3;
std::cin >> x3;
std::cin >> y3;
std::cout << "Import coordinates for ani D dot " << std::endl;
int x, y;
std::cin >> x;
std::cin >> y;
...
{
std::cout << "D is located in ABC triangle " << std::endl;
}
else
std::cout << "D is not located in ABC triangle " << std::endl;
