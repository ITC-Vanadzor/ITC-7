...
int main()
{
  double x1,y1,x2,y2,x3,y3; // A B C keteri koordinatnery
  ...
  double a=Erankyan_Koxm(x1,y1,x2,y2); // AB 
  double b=Erankyan_Koxm(x2,y2,x3,y3); // BC
  double c=Erankyan_Koxm(x3,y3,x1,y1); // AC
