...
INSERT INTO `valueinterval` VALUES (1,1,10000),(2,2,50000),(3,3,110000);
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER sal AFTER UPDATE ON valueinterval FOR EACH ROW  BEGIN  declare x INT; select valueinterval.level from valueinterval where new.v_id=level.level_id into x; update level set level_id = x where worker.salary > new.sal AND worker_id = worker.id; end */;;
DELIMITER ;
...
-- Dump completed on 2016-04-09  2:56:33
