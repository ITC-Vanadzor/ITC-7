...
CREATE TABLE `card` (
  ...
  CONSTRAINT `city_id_fk` FOREIGN KEY (`city_id`) REFERENCES `city` (`c_id`),
  CONSTRAINT `img_fk` FOREIGN KEY (`image`) REFERENCES `images` (`id_card`),
  CONSTRAINT `type_fk` FOREIGN KEY (`id_type`) REFERENCES `sub_category` (`id`)
...
CREATE TABLE `detail` (
  ...
  `description` blob,
  KEY `card_id_fk` (`id_card`),
  CONSTRAINT `card_id_fk` FOREIGN KEY (`id_card`) REFERENCES `card` (`id_card`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `optional_info` (
  ...
  KEY `opt_inf_fk` (`field_id`),
  KEY `c_id_fk` (`id_card`),
  CONSTRAINT `c_id_fk` FOREIGN KEY (`id_card`) REFERENCES `detail` (`id_card`),
  CONSTRAINT `opt_inf_fk` FOREIGN KEY (`field_id`) REFERENCES `optional_field` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `popular` (
  ...
  PRIMARY KEY (`id`),
  KEY `popular_id_fk` (`id_card`),
  CONSTRAINT `popular_id_fk` FOREIGN KEY (`id_card`) REFERENCES `card` (`id_card`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
